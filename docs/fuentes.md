...
Documentos madre del proyecto. Toda afirmación normativa del simulador debe poder rastrearse hasta uno de estos textos, citando artículo o numeral.

Regla: solo fuentes oficiales (Ministerio de Salud, INVIMA, MinTIC, Diario Oficial, SUIN-Juriscol). Nada de blogs ni consultoras, que suelen estar desactualizados o recortados.

Última revisión: 16 de septiembre de 2026

| Estado | Significado |
|---|---|
| Descargado | El PDF está en `fuentes/` y se verificó que abre |
| Por localizar | Falta encontrar la versión oficial |
| Por verificar | Hay enlace, falta confirmar vigencia o versión |

---

## Módulo 1 · Habilitación
...
| Decreto 780 de 2016 | Decreto único del sector; compila el SOGCS | — | Por localizar |
| Resolución 77 de 2007 | Lineamientos para los verificadores | — | Por localizar |

## Módulo 2 · PAMEC

| Documento | Aporta | Enlace | Estado |
|---|---|---|---|
| Pautas indicativas de auditoría para el mejoramiento | Metodología del PAMEC y ruta crítica | — | Por localizar |
| Resolución 256 de 2016 | Sistema de información para la calidad e indicadores | — | Por localizar |

## Módulo 3 · INVIMA y vigilancia posmercado
...
## Módulo 4 · Seguridad del paciente

| Documento | Aporta | Enlace | Estado |
|---|---|---|---|
| Lineamientos de la política de seguridad del paciente | Marco conceptual del módulo | — | Por localizar |
| Paquetes instruccionales de buenas prácticas | Contenido didáctico de referencia | — | Por localizar |

## Módulo 5 · Seguridad de la información

| Documento | Aporta | Enlace | Estado |
|---|---|---|---|
| Resolución MinTIC 02277 de 2025 | Actualiza el MSPI | — | Por localizar |
| Guías del MSPI | Material bajo licencia Creative Commons, reutilizable | — | Por localizar |
| Ley 2015 de 2020 | Historia clínica electrónica interoperable | — | Por localizar |
| Resolución 866 de 2021 | Datos clínicos para la interoperabilidad | — | Por localizar |
| Resolución 1995 de 1999 | Manejo de la historia clínica | — | Por localizar |
| Resolución 839 de 2017 | Custodia y retención de historias clínicas | — | Por localizar |

## Módulo 6 · Protección de datos

| Documento | Aporta | Enlace | Estado |
|---|---|---|---|
| Ley 1581 de 2012 | Régimen general de protección de datos personales | — | Por localizar |
| Decreto 1074 de 2015, libro 2 parte 2 título 2 | Reglamentación de la Ley 1581 | — | Por localizar |

## Módulo 7 · Acreditación
...
## Cómo se registra una fuente

Cuando se descargue un documento, se anota aquí: enlace exacto, fecha de descarga y quién la hizo. Los PDF viven en `fuentes/`, que está fuera del control de versiones por tamaño y por derechos de terceros.

## Pendiente de confirmar

- Si la biblioteca de ECCI tiene acceso licenciado al catálogo de ICONTEC.
- Publicación de la Resolución 2080 de 2026 en el Diario Oficial.
